...
module Box_top #(
    ...
    //green
    output logic [8:0] o_red_cst_x_max  [0:NUM_BOXES-1],
    output logic [8:0] o_red_cst_x_min  [0:NUM_BOXES-1],
    output logic [7:0] o_red_cst_y_max  [0:NUM_BOXES-1],
    output logic [7:0] o_red_cst_y_min  [0:NUM_BOXES-1],
    output logic       o_red_cst_valid  [0:NUM_BOXES-1],
    //green
    output logic [8:0] o_green_cst_x_max[0:NUM_BOXES-1],
    output logic [8:0] o_green_cst_x_min[0:NUM_BOXES-1],
    output logic [7:0] o_green_cst_y_max[0:NUM_BOXES-1],
    output logic [7:0] o_green_cst_y_min[0:NUM_BOXES-1],
    output logic       o_green_cst_valid[0:NUM_BOXES-1],
    //blue
    output logic [8:0] o_blue_cst_x_max [0:NUM_BOXES-1],
    output logic [8:0] o_blue_cst_x_min [0:NUM_BOXES-1],
    output logic [7:0] o_blue_cst_y_max [0:NUM_BOXES-1],
    output logic [7:0] o_blue_cst_y_min [0:NUM_BOXES-1],
    output logic       o_blue_cst_valid [0:NUM_BOXES-1]
);
  ...
  logic [8:0] grn_cst_x_min[0:NUM_BOXES-1];
  logic [8:0] grn_cst_x_max[0:NUM_BOXES-1];
  logic [7:0] grn_cst_y_min[0:NUM_BOXES-1];
  logic [7:0] grn_cst_y_max[0:NUM_BOXES-1];
  logic       grn_cst_valid[0:NUM_BOXES-1];

  logic [8:0] blu_cst_x_min[0:NUM_BOXES-1];
  logic [8:0] blu_cst_x_max[0:NUM_BOXES-1];
  logic [7:0] blu_cst_y_min[0:NUM_BOXES-1];
  logic [7:0] blu_cst_y_max[0:NUM_BOXES-1];
  logic       blu_cst_valid[0:NUM_BOXES-1];

  //red
  assign o_red_cst_x_max   = red_cst_x_max;
  assign o_red_cst_x_min   = red_cst_x_min;
  assign o_red_cst_y_max   = red_cst_y_max;
  assign o_red_cst_y_min   = red_cst_y_min;
  assign o_red_cst_valid   = red_cst_valid;
  //green
  assign o_green_cst_x_max = grn_cst_x_max;
  assign o_green_cst_x_min = grn_cst_x_min;
  assign o_green_cst_y_max = grn_cst_y_max;
  assign o_green_cst_y_min = grn_cst_y_min;
  assign o_green_cst_valid = grn_cst_valid;
  //blue
  assign o_blue_cst_x_max  = blu_cst_x_max;
  assign o_blue_cst_x_min  = blu_cst_x_min;
  assign o_blue_cst_y_max  = blu_cst_y_max;
  assign o_blue_cst_y_min  = blu_cst_y_min;
  assign o_blue_cst_valid  = blu_cst_valid;
  ...
  // ── box_constraint ─────────────────────────────────────────
  box_constraint u_box_constraint_red (
      .in_x_min (red_trk_x_min),
      .in_x_max (red_trk_x_max),
      .in_y_min (red_trk_y_min),
      .in_y_max (red_trk_y_max),
      .in_valid (red_trk_valid),
      .out_x_min(red_cst_x_min),
      .out_x_max(red_cst_x_max),
      .out_y_min(red_cst_y_min),
      .out_y_max(red_cst_y_max),
      .out_valid(red_cst_valid)
  );
  box_constraint u_box_constraint_grn (
      .in_x_min (grn_trk_x_min),
      .in_x_max (grn_trk_x_max),
      .in_y_min (grn_trk_y_min),
      .in_y_max (grn_trk_y_max),
      .in_valid (grn_trk_valid),
      .out_x_min(grn_cst_x_min),
      .out_x_max(grn_cst_x_max),
      .out_y_min(grn_cst_y_min),
      .out_y_max(grn_cst_y_max),
      .out_valid(grn_cst_valid)
  );

  box_constraint u_box_constraint_blu (
      .in_x_min (blu_trk_x_min),
      .in_x_max (blu_trk_x_max),
      .in_y_min (blu_trk_y_min),
      .in_y_max (blu_trk_y_max),
      .in_valid (blu_trk_valid),
      .out_x_min(blu_cst_x_min),
      .out_x_max(blu_cst_x_max),
      .out_y_min(blu_cst_y_min),
      .out_y_max(blu_cst_y_max),
      .out_valid(blu_cst_valid)
  );
  ...
  box_edge_img #(
      ...
      .x_pixel      (x_pixel),
      .y_pixel      (y_pixel),
      .red_box_x_min(red_cst_x_min),
      .red_box_x_max(red_cst_x_max),
      .red_box_y_min(red_cst_y_min),
      .red_box_y_max(red_cst_y_max),
      .red_box_valid(red_cst_valid),
      .grn_box_x_min(grn_cst_x_min),
      .grn_box_x_max(grn_cst_x_max),
      .grn_box_y_min(grn_cst_y_min),
      .grn_box_y_max(grn_cst_y_max),
      .grn_box_valid(grn_cst_valid),
      .blu_box_x_min(blu_cst_x_min),
      .blu_box_x_max(blu_cst_x_max),
      .blu_box_y_min(blu_cst_y_min),
      .blu_box_y_max(blu_cst_y_max),
      .blu_box_valid(blu_cst_valid),
