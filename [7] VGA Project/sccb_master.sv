`timescale 1ns / 1ps
//=============================================================================
// SCCB Master for OV7670
// - Based on i2c_master design pattern
// - 3-Phase Write: [Device Addr 0x42] + [Reg Addr] + [Reg Data]
// - ACK = Don't Care (SCCB spec)
// - Write-only (Read not implemented — not needed for init)
//=============================================================================
module sccb_master #(
