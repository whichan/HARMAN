...
module fifo(
    ...
    register_file #(
        ...
        .rd(~empty & rd), //empty가 아니면서 rd=1일 때만 read
        .rdata(rdata)
    );
...
module register_file #(
    ...
    input clk,
    input [2:0] waddr, //4byte buffer이므로 2개의 주소 필요
    ...
    logic [7:0] register_file [0:DATA_BYTE-1]; //data 8bit, size n byte
...
module fifo_control_unit(
    ...
    logic [2:0] c_wptr, n_wptr, c_rptr, n_rptr;
