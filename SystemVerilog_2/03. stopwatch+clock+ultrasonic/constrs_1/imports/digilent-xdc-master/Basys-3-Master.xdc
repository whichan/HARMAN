...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { mode_sw  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
...
set_property -dict { PACKAGE_PIN W7  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[0] }]; #IO_L13P_T2_MRCC_34 ,Sch=seg[0]
set_property -dict { PACKAGE_PIN W6  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[1] }]; #IO_L13N_T2_MRCC_34 ,Sch=seg[1]
set_property -dict { PACKAGE_PIN U8  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[2] }]; #IO_L14P_T2_SRCC_34 ,Sch=seg[2]
set_property -dict { PACKAGE_PIN V8  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[3] }]; #IO_L14N_T2_SRCC_34 ,Sch=seg[3]
set_property -dict { PACKAGE_PIN U5  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[4] }]; #IO_L16P_T2_34      ,Sch=seg[4]
set_property -dict { PACKAGE_PIN V5  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[5] }]; #IO_L16N_T2_34      ,Sch=seg[5]
set_property -dict { PACKAGE_PIN U7  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[6] }]; #IO_L19P_T3_34      ,Sch=seg[6]
set_property -dict { PACKAGE_PIN V7  IOSTANDARD LVCMOS33 } [get_ports { fnd_font[7] }]; #IO_L19N_T3_VREF_34 ,Sch=seg[7]

set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { fnd_com[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=an[0]
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { fnd_com[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=an[1]
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { fnd_com[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=an[2]
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { fnd_com[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=an[3]


##Buttons

set_property -dict { PACKAGE_PIN U18  IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L18N_T2_A11_D27_14 ,Sch=BTNC
set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { mode }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { run_stop }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { clear }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { ultrasonic }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
...
set_property -dict { PACKAGE_PIN J2  IOSTANDARD LVCMOS33 } [get_ports { echo }]; #IO_L2N_T0_AD12N_35    ,Sch=JA3
set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports { trig }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
