            ...
            case (state)
                ...
                S_LOAD_DATA: begin
                    case (char_idx)
                        ...
                        8: tx_data <= {4'b0011, digit_th}; 
                        9: tx_data <= {4'b0011, digit_hu};
                        10: tx_data <= {4'b0011, digit_te};
                        11: tx_data <= {4'b0011, digit_on};
                            // ", mode: "
                        12: tx_data <= ",";
                        13: tx_data <= " ";
                        14: tx_data <= "m";
                        ...
                        19: tx_data <= " ";
                        // UP / DN
                        20: tx_data <= saved_mode ? "U" : "D";
                        21: tx_data <= saved_mode ? "P" : "N";
                        // 줄바꿈
                        22: tx_data <= 8'h0D; // \r
                        23: tx_data <= 8'h0A; // \n
                        default: tx_data <= " ";
